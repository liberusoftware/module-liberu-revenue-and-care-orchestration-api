...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-liberu-revenue-and-care-orchestration-api?sort=semver)](https://github.com/liberusoftware/module-liberu-revenue-and-care-orchestration-api/releases/latest) [![Tests](https://github.com/liberusoftware/module-liberu-revenue-and-care-orchestration-api/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-liberu-revenue-and-care-orchestration-api/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-liberu-revenue-and-care-orchestration-api
```
...
<a href="https://github.com/liberusoftware/module-liberu-revenue-and-care-orchestration-api/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-liberu-revenue-and-care-orchestration-api" alt="Contributors to liberusoftware/module-liberu-revenue-and-care-orchestration-api">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-liberu-revenue-and-care-orchestration-api/graphs/contributors).
